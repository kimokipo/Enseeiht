...
let%expect_test "teststruct1" =
  runtam "../../fichiersRat/src-rat-tam-test/teststruct1.rat";
  [%expect{| 3[1/4] |}]
...
let%expect_test "teststruct8" =
        runtam "../../fichiersRat/src-rat-tam-test/teststruct8.rat";
        [%expect{| 123 |}]

let%expect_test "teststruct9" =
      runtam "../../fichiersRat/src-rat-tam-test/teststruct9.rat";
