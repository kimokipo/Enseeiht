...
prog :
| td1 = td lf = fonc  lfi = prog   {(Programme (td1,lf,lfi))}
| ID li = bloc            {Bloc (li)}

td : 
|                         {[]}
| TD n=TID EQUAL t=typ PV ltd=td              {(n,t)::ltd}
...
| TD n=TID EQUAL t=typ PV           {DefinitionType(n,t)}
...
| n=TID           {TypeNomme n}
| STRUCT AO lp=dp AF   {TypeStruct(lp)}
