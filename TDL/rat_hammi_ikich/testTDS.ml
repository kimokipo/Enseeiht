...
let%test_unit "teststruct1" = 
  let _ = compiler   "../../fichiersRat/src-rat-tam-test/teststruct1.rat" in ()

let%test_unit "teststruct2" = 
  let _ = compiler   "../../fichiersRat/src-rat-tam-test/teststruct2.rat" in ()

let%test_unit "teststruct3" = 
  let _ = compiler   "../../fichiersRat/src-rat-tam-test/teststruct3.rat" in ()


let%test_unit "teststruct4" = 
try 
  let _ = compiler   "../../fichiersRat/src-rat-tam-test/teststruct4.rat" in
   raise ErreurNonDetectee
with
| DoubleDeclaration("x") -> ()

let%test_unit "teststruct5" = 
try 
  let _ = compiler   "../../fichiersRat/src-rat-tam-test/teststruct5.rat" in
   raise ErreurNonDetectee
with
| DoubleDeclaration("x") -> ()

let%test_unit "teststruct6" = 
  let _ = compiler   "../../fichiersRat/src-rat-tam-test/teststruct6.rat" in ()


let%test_unit "teststruct7" = 
let _ = compiler   "../../fichiersRat/src-rat-tam-test/teststruct7.rat" in ()

let%test_unit "teststruct8" = 
let _ = compiler   "../../fichiersRat/src-rat-tam-test/teststruct8.rat" in ()


let%test_unit "teststruct9" = 
let _ = compiler   "../../fichiersRat/src-rat-tam-test/teststruct9.rat" in ()
*)
