...
public class ExempleSchema1 {
	...
	public static void main(String[] args)
	{
		...
		// Dessiner le schéma
		Ecran ecran = new Ecran("Schéma1", 600, 400, 20);
		ecran.dessinerAxes();
		s12.dessiner(ecran);		
		s23.dessiner(ecran);		
		s31.dessiner(ecran);		
		...
		// Afficher et Dessiner la schéma de nouveau
		...
		AfficheurSVG afficheurSVG = new AfficheurSVG("Schéma1EnSVG","Schéma1EnSVG", 400, 200);
		...
		// Afficher le schéma sous forme d'un texte explicite
		Afficheur afficheurTexte = new AfficheurTexte();
