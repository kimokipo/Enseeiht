...
public class ExempleSchemaList {
	...
	public static void main(String[] args)
	{
		...
		java.util.ArrayList<ObjetGeometrique> schema = new java.util.ArrayList<ObjetGeometrique>(10);	// le schéma
		...
		schema.add(nb++,s23);
		schema.add(nb++,s31);
		schema.add(nb++,barycentre);

		// Afficher le schéma
		System.out.println("Le schéma est composé de : ");
		for (ObjetGeometrique e : schema) {
 			e.afficher();
			System.out.println();
		}
