...
public abstract class AgendaAbstrait extends ObjetNomme implements Agenda {
	 ...
	 * Vérifier un creneau .
	 *
	 * @param creneau le creneau à vérifier
	 * @throws CreneauInvalideException si creneau n'est pas dans les limites attendues
	 */
	static void verifierCreneauValide(int creneau) throws CreneauInvalideException{
