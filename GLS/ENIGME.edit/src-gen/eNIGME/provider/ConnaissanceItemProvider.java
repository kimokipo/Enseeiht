...
/**
 * This is the item provider adapter for a {@link eNIGME.Connaissance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnaissanceItemProvider extends JeuElementItemProvider {
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Connaissance_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Connaissance_name_feature",
								"_UI_Connaissance_type"),
						ENIGMEPackage.Literals.CONNAISSANCE__NAME, true, false, false,
	...
	protected void addNomConnaissancePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Connaissance_nomConnaissance_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Connaissance_nomConnaissance_feature",
								"_UI_Connaissance_type"),
						ENIGMEPackage.Literals.CONNAISSANCE__NOM_CONNAISSANCE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addQualificationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Connaissance_qualification_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Connaissance_qualification_feature",
								"_UI_Connaissance_type"),
						ENIGMEPackage.Literals.CONNAISSANCE__QUALIFICATION, true, false, true, null, null, null));
	}
	...
	protected void addEtatvPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Connaissance_etatv_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Connaissance_etatv_feature",
								"_UI_Connaissance_type"),
						ENIGMEPackage.Literals.CONNAISSANCE__ETATV, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addEtatpPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Connaissance_etatp_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Connaissance_etatp_feature",
								"_UI_Connaissance_type"),
						ENIGMEPackage.Literals.CONNAISSANCE__ETATP, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Connaissance_type")
