 ...
 * <!-- end-user-doc -->
 * @see fr.n7.eNIGME.ENIGMEPackage#getEtatReponse()
 * @model
 * @generated
 */
public enum EtatReponse implements Enumerator
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  private static final EtatReponse[] VALUES_ARRAY =
    new EtatReponse[] {
			BONNE,
			MAUVAISE,
		};
  ...
  {
		switch (value) {
			case BONNE_VALUE: return BONNE;
			case MAUVAISE_VALUE: return MAUVAISE;
		}
		return null;
	}
