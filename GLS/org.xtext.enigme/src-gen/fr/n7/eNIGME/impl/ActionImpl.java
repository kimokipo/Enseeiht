 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.eNIGME.impl.ActionImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.n7.eNIGME.impl.ActionImpl#getObjetsconsommables <em>Objetsconsommables</em>}</li>
 *   <li>{@link fr.n7.eNIGME.impl.ActionImpl#getObjetsattribuables <em>Objetsattribuables</em>}</li>
 *   <li>{@link fr.n7.eNIGME.impl.ActionImpl#getConnaissancesattribuables <em>Connaissancesattribuables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionImpl extends JeuElementImpl implements Action
{
  ...
  public EList<Objet> getObjetsconsommables()
  {
		if (objetsconsommables == null) {
			objetsconsommables = new EObjectResolvingEList<Objet>(Objet.class, this, ENIGMEPackage.ACTION__OBJETSCONSOMMABLES);
		}
  ...
  public EList<Objet> getObjetsattribuables()
  {
		if (objetsattribuables == null) {
			objetsattribuables = new EObjectResolvingEList<Objet>(Objet.class, this, ENIGMEPackage.ACTION__OBJETSATTRIBUABLES);
		}
  ...
  public EList<Connaissance> getConnaissancesattribuables()
  {
		if (connaissancesattribuables == null) {
			connaissancesattribuables = new EObjectResolvingEList<Connaissance>(Connaissance.class, this, ENIGMEPackage.ACTION__CONNAISSANCESATTRIBUABLES);
		}
