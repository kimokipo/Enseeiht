...
public class ENIGMEPackageImpl extends EPackageImpl implements ENIGMEPackage
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see fr.n7.eNIGME.ENIGMEPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
  ...
  {
		if (isInited) return (ENIGMEPackage)EPackage.Registry.INSTANCE.getEPackage(ENIGMEPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredENIGMEPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ENIGMEPackageImpl theENIGMEPackage = registeredENIGMEPackage instanceof ENIGMEPackageImpl ? (ENIGMEPackageImpl)registeredENIGMEPackage : new ENIGMEPackageImpl();
  ...
  public void initializePackageContents()
  {
		...
		initEAttribute(getConnaissance_NomConnaissance(), ecorePackage.getEString(), "nomConnaissance", null, 0, 1, Connaissance.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getObjet_NomObjet(), ecorePackage.getEString(), "nomObjet", null, 0, 1, Objet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getQualification_Id(), ecorePackage.getEInt(), "id", null, 0, 1, Qualification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getReponse_Etat(), this.getEtatReponse(), "etat", null, 0, 1, Reponse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
