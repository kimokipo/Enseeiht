 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.eNIGME.impl.PersonneImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.n7.eNIGME.impl.PersonneImpl#getEtato <em>Etato</em>}</li>
 *   <li>{@link fr.n7.eNIGME.impl.PersonneImpl#getConditiono <em>Conditiono</em>}</li>
 *   <li>{@link fr.n7.eNIGME.impl.PersonneImpl#getEtatv <em>Etatv</em>}</li>
 *   <li>{@link fr.n7.eNIGME.impl.PersonneImpl#getConditionv <em>Conditionv</em>}</li>
 *   <li>{@link fr.n7.eNIGME.impl.PersonneImpl#getTexte <em>Texte</em>}</li>
 *   <li>{@link fr.n7.eNIGME.impl.PersonneImpl#getInteraction <em>Interaction</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PersonneImpl extends JeuElementImpl implements Personne
{
  ...
  public Condition getConditiono()
  {
		if (conditiono != null && conditiono.eIsProxy()) {
			...
			if (conditiono != oldConditiono) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ENIGMEPackage.PERSONNE__CONDITIONO, oldConditiono, conditiono));
			}
		}
		return conditiono;
	}
  ...
  public void setConditiono(Condition newConditiono)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ENIGMEPackage.PERSONNE__CONDITIONO, oldConditiono, conditiono));
	}
  ...
  public Condition getConditionv()
  {
		if (conditionv != null && conditionv.eIsProxy()) {
			...
			if (conditionv != oldConditionv) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ENIGMEPackage.PERSONNE__CONDITIONV, oldConditionv, conditionv));
			}
		}
		return conditionv;
	}
  ...
  public void setConditionv(Condition newConditionv)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ENIGMEPackage.PERSONNE__CONDITIONV, oldConditionv, conditionv));
	}
  ...
  public Qualification getTexte()
  {
		if (texte != null && texte.eIsProxy()) {
			...
			if (texte != oldTexte) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ENIGMEPackage.PERSONNE__TEXTE, oldTexte, texte));
			}
		}
		return texte;
	}
  ...
  public Interaction getInteraction()
  {
		if (interaction != null && interaction.eIsProxy()) {
			...
			if (interaction != oldInteraction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ENIGMEPackage.PERSONNE__INTERACTION, oldInteraction, interaction));
			}
		}
		return interaction;
	}
  ...
  public void setInteraction(Interaction newInteraction)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ENIGMEPackage.PERSONNE__INTERACTION, oldInteraction, interaction));
	}
