 ...
 * </p>
 * <ul>
 *   <li>{@link eNIGME.impl.ConnaissanceImpl#getName <em>Name</em>}</li>
 *   <li>{@link eNIGME.impl.ConnaissanceImpl#getNomConnaissance <em>Nom Connaissance</em>}</li>
 *   <li>{@link eNIGME.impl.ConnaissanceImpl#getQualification <em>Qualification</em>}</li>
 *   <li>{@link eNIGME.impl.ConnaissanceImpl#getEtatv <em>Etatv</em>}</li>
 *   <li>{@link eNIGME.impl.ConnaissanceImpl#getEtatp <em>Etatp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConnaissanceImpl extends JeuElementImpl implements Connaissance {
	...
	public void setNomConnaissance(String newNomConnaissance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ENIGMEPackage.CONNAISSANCE__NOM_CONNAISSANCE,
					oldNomConnaissance, nomConnaissance));
	}
	...
	public Qualification getQualification() {
		if (qualification != null && qualification.eIsProxy()) {
			...
			if (qualification != oldQualification) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ENIGMEPackage.CONNAISSANCE__QUALIFICATION,
	...
	public void setQualification(Qualification newQualification) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ENIGMEPackage.CONNAISSANCE__QUALIFICATION,
					oldQualification, qualification));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case ENIGMEPackage.CONNAISSANCE__NOM_CONNAISSANCE:
			return NOM_CONNAISSANCE_EDEFAULT == null ? nomConnaissance != null
					: !NOM_CONNAISSANCE_EDEFAULT.equals(nomConnaissance);
		case ENIGMEPackage.CONNAISSANCE__QUALIFICATION:
