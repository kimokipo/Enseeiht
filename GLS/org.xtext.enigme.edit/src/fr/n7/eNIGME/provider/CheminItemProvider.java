...
/**
 * This is the item provider adapter for a {@link fr.n7.eNIGME.Chemin} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CheminItemProvider 
	...
	protected void addConditioncPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Chemin_conditionc_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Chemin_conditionc_feature", "_UI_Chemin_type"),
				 ENIGMEPackage.Literals.CHEMIN__CONDITIONC,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addConditionoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Chemin_conditiono_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Chemin_conditiono_feature", "_UI_Chemin_type"),
				 ENIGMEPackage.Literals.CHEMIN__CONDITIONO,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addConditionvPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Chemin_conditionv_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Chemin_conditionv_feature", "_UI_Chemin_type"),
				 ENIGMEPackage.Literals.CHEMIN__CONDITIONV,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPrecedentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Chemin_precedent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Chemin_precedent_feature", "_UI_Chemin_type"),
				 ENIGMEPackage.Literals.CHEMIN__PRECEDENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSuivantPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Chemin_suivant_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Chemin_suivant_feature", "_UI_Chemin_type"),
				 ENIGMEPackage.Literals.CHEMIN__SUIVANT,
				 true,
				 false,
				 true,
				 null,
