-- Implantation d'un module Dates trÃ¨s simplifiÃ©.
...
package body Dates is
    ...
    -- Afficher un entier sur 2 positons au moins (avec des zÃ©ros
    -- supplÃ©mentaires si nÃ©cessaires)
    --
    -- ParamÃ¨tres :
    --     Nombre : le nombre Ã  afficher
    --
    -- NÃ©cessite :
    --     Nombre >= 0
    --
