...
moyen_carre_masque = repmat(individu_moyen_masque,n,1);

% Centrage de la matrice X :
X_centre_masque = X_masque - kron(ones(n,1),individu_moyen_masque);
...
V1 = transpose(X_centre_masque) * V2
% Tri par ordre décroissant des valeurs propres de Sigma2 :
[D2,Indices] = sort(diag(D2), "descend");
V2 = V2(:,Indices);
