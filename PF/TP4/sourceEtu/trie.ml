...
(******************************************************************************)
let appartient mot trie = let Trie (a,decomp,_) = trie in appartient_arbre (decomp mot) a
...
(******************************************************************************)
let retrait mot trie = let Trie (a,decomp,recomp) = trie in Trie (normalisation_arbre (retrait_arbre (decomp mot) a),decomp,recomp)
...
(*   résultat   : aucun                                                       *)
(******************************************************************************)
let affiche p trie = let Trie (a,_,recomp) = trie in List.iter p (List.map (fun x -> recomp x) (parcours_arbre a))
