/* Scrapper 100 posts au maximum de chaque groupe, 
     et stocker leurs réactions dans la base de données
*/
...
import analyserGroupes from './src/analyserGroupes.js'
 ...
 (async function () {
    ...
    if (process.argv.length < 4) {
	    ...
	    console.log('\nfacebook')
	            ...
	            const Ids = await analyserGroupes(page,id_ambassadeur,rapport)
...
function AfficherMenu(){
            ...
            console.log('node analyseGroupes.js Prenom nom\n')
