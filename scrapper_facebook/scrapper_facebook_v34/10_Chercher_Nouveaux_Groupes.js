...
import login from './src/login.js'
 ...
 (async function () {
    ...
    const mot_clee = process.argv.slice(5).join(' ')
    ...
    if (process.argv.length < 5) {
        ...
        if (nom && (await getIdAmbassadeur(prenom,nom)) && prenom && (await getLoginAmbassadeur(prenom,nom)) && mot_clee ){
	    ...
	    console.log('\nfacebook')
                ...
                const Ids = await chercherGroupes(page,mot_clee,nb_groupes,id_ambassadeur,rapport)
...
function AfficherMenu(){
            ...
            console.log('node 10_Chercher_Nouveaux_Groupes.js Prenom nom nb_groupes mot_clee \n')
