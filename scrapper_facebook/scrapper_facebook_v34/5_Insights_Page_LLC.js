/* Relever le nobmre de mentions J'aime, nombre d'abonnés, et nombre de vues
     de la page FB LLC et les stocker dans la base de données
*/
...
import scrapperPageLlc from './src/scrapperPageLlc.js'
...
import login from './src/login.js'
 ...
 (async function () {
    ...
    if (process.argv.length < 5) {
            ...
            await AfficherMenu()
    }else if (nom && (await getIdAmbassadeur(prenom,nom)) && prenom && (await getLoginAmbassadeur(prenom,nom)) && id_campagne != null) {
        ...
        const Ids = await scrapperPageLlc(page,id_campagne,rapport)
...
function AfficherMenu(){
            ...
            console.log('node scrappePageLlc.js Prenom nom id_campagne\n')
