 ...
 * @param {Number} idPost_probleme
 * @param {string} rapport
 */
export default async function (page,prenom,loginPassword,id_campagne,id_releve_campagne,idPost_probleme,rapport) {
