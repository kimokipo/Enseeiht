...
export default (page,id_ambassadeur,nb_groupes,rapport) => {
    return new Promise(async resolve => {
        const LinkGroup = []
            ...
            var temps = 0
            var groupes_recuperes = await getGroupesAmbassadeurAdhesion(db,id_ambassadeur)
            var groupes = groupes_recuperes.slice(0,nb_groupes)
            ...
            await asyncForEach(groupes, async groupe => {
	           ...
	           if (groupes.length == 0){
	               ...
	               var today = new Date()
	                rapport = rapport + '\n| Report Releve Adhesion Groupes"'+today.toString()+'" |\n'
