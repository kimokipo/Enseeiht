...
import InsertGroupeAmbassadeur from './InsertGroupeAmbassadeur.js'
 ...
 */
export default (page,mot_clee,nb_groupes,id_ambassadeur,rapport) => {
                     ...
                     if (groupes_ajoutes.length < nb_groupes){
                         ...
                         if(err){
                            ...
                            ajoute = 'non ajouté'
                             ...
                             var err = await InsertGroupeAmbassadeur(db,groupLink,id_ambassadeur,'à valider')
