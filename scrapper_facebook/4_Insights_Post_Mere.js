...
import login from './src/login.js'
 ...
 (async function () {
    ...
    if (process.argv.length < 6) {
        ...
        if (nom && (await getIdAmbassadeur(nom)) && prenom && (await getLoginAmbassadeur(prenom)) && id_campagne && id_releve_campagne && (await getStatutReleveCampagne(id_releve_campagne))) {
...
function AfficherMenu(){
            ...
            console.log('node scrappePostMere.js Prenom nom id_campagne id_releve_campagne\n')
