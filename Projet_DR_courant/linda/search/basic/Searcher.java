...
public class Searcher implements Runnable {
    ...
    public Searcher(Linda linda, int k) {
        this.linda = linda;
        this.k = k;
    ...
    public void run() {
        ...
        Tuple treq = linda.read(new Tuple(Code.Request, UUID.class, String.class, this.k));
        UUID reqUUID = (UUID)treq.get(1);
        String req = (String) treq.get(2);
        Tuple tv;
        System.out.println("thread "+ k + " Looking for: " + req);
        while ((tv = linda.tryTake(new Tuple(Code.Value, String.class))) != null && i>=2000*k && i<2000*(k+1)) {
        ...
        linda.write(new Tuple(Code.Searcher, "done",k, reqUUID));
    }
