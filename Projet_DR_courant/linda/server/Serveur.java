...
public interface Serveur extends Remote {
     ...
     */
    public void eventRegister(String mode, String timing, Tuple template, Mycallback callback) throws RemoteException;
    
    public void eventCorrection(Tuple t, Mycallback callback) throws RemoteException;
