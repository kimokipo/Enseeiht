...
public class TestAsynchCallBackFRead {
    ...
    private static class MyCallback implements Callback {
        ...
        public void call(Tuple t) {
            ...
            linda.eventRegister(eventMode.READ, eventTiming.FUTURE, cbmotif, this);
            try {
                Thread.sleep(1000);
        ...
        for (int i = 1; i <= 3; i++) {
            ...
            new Thread() {  
                public void run() {
                    ...
                    linda.eventRegister(eventMode.READ, eventTiming.FUTURE, cbmotif, new AsynchronousCallback (new MyCallback(j)));    
                    linda.debug("("+j+")");
                }
            }.start();
        }
