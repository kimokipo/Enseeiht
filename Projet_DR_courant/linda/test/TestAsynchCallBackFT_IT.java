...
public class TestAsynchCallBackFT_IT {
        ...
        cbmotif = new Tuple(Integer.class, String.class);
            new Thread() {  
                public void run() {
                    ...
                    linda.eventRegister(eventMode.TAKE, eventTiming.FUTURE, cbmotif, new AsynchronousCallback( new MyCallback(1,eventMode.TAKE,eventTiming.FUTURE)));    
                    linda.debug("(1)");
                }
            }.start();
