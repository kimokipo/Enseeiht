...
public class TestAsynchCallBackFT_IR {
        ...
        cbmotif = new Tuple(Integer.class, String.class);
            ...
            new Thread() {  
                public void run() {
                    ...
                    linda.eventRegister(eventMode.READ, eventTiming.IMMEDIATE, cbmotif, new AsynchronousCallback(new MyCallback(2,eventMode.READ,eventTiming.IMMEDIATE)));    
                    linda.debug("(2)");
                }
            }.start();
