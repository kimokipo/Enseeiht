...
public class CentralizedLinda implements Linda {
    ...
    private ReentrantLock mon_moniteur_callback;
    ...
    private HashMap<Tuple,ArrayList<Callback>> liste_callbacks_correction;

    public CentralizedLinda() {
        listeOftyples = new ArrayList<Tuple>();
        this.mon_moniteur = new ReentrantLock();
        this.mon_moniteur_callback = new ReentrantLock();
        ...
        this.liste_callbacks_correction = new HashMap<Tuple,ArrayList<Callback>>();
    }
    ...
    private void corriger(Tuple t){
        for(Map.Entry<Tuple,ArrayList<Callback>> e : liste_callbacks_correction.entrySet()){
            if (t.matches(e.getKey())){
                ArrayList<Callback> private_liste = new ArrayList<Callback>(e.getValue());
                for (Callback c :private_liste){
                    c.call(t);
                }
            }
        }
    ...
    public void eventCorrection(Tuple t, Callback callback){
        ArrayList<Callback> liste = liste_callbacks_correction.get(t);
        if (liste == null) {
            liste = new ArrayList<Callback>();
        }
        liste.add(callback);
        liste_callbacks_correction.put(t,liste);
    }
