...
public class PhiloSem_sol1 implements StrategiePhilo {

    /****************************************************************/
    private Semaphore [] Fourchettes;
    
    public PhiloSem_sol1 (int nbPhilosophes) {
    ...
    public String nom() {
        return "Implantation Sémaphores, stratégie d'inverser l'appris des fourchettes pour un philosophe";
    }
