...
public class TestAsynchCallBackFR_IR {
        ...
        cbmotif = new Tuple(Integer.class, String.class);
            new Thread() {  
                public void run() {
                    ...
                    linda.eventRegister(eventMode.READ, eventTiming.FUTURE, cbmotif, new AsynchronousCallback (new MyCallback(1,eventMode.READ,eventTiming.FUTURE)));    
                    linda.debug("(1)");
                }
            }.start();
            ...
            new Thread() {  
                public void run() {
                    ...
                    linda.eventRegister(eventMode.READ, eventTiming.IMMEDIATE, cbmotif, new MyCallback(2,eventMode.READ,eventTiming.IMMEDIATE));    
                    linda.debug("(2)");
                }
            }.start();
