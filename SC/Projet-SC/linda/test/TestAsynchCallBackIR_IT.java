...
public class TestAsynchCallBackIR_IT {
        ...
        cbmotif = new Tuple(Integer.class, String.class);
            new Thread() {  
                public void run() {
                    ...
                    linda.eventRegister(eventMode.READ, eventTiming.IMMEDIATE, cbmotif, new AsynchronousCallback (new MyCallback(1,eventMode.READ,eventTiming.IMMEDIATE)));    
                    linda.debug("(1)");
                }
            }.start();
