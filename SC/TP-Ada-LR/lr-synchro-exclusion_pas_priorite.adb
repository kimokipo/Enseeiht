...
package body LR.Synchro.Exclusion_Pas_Priorite is
   
   function Nom_Strategie return String is
   begin
      return "Exclusion mutuelle simple pas de priorité";
   end Nom_Strategie;
   ...
   begin
      loop
      	select
            when (not ecriture) => accept Demander_Lecture; nblect := nblect + 1;
    	   or
...
end LR.Synchro.Exclusion_Pas_Priorite;