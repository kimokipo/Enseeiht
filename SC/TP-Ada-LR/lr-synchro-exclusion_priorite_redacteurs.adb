...
package body LR.Synchro.Exclusion_Priorite_Redacteurs is
   
   function Nom_Strategie return String is
   begin
      return "Exclusion mutuelle simple, Priorite aux rédacteurs";
   end Nom_Strategie;
...
end LR.Synchro.Exclusion_Priorite_Redacteurs;