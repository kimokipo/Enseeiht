...
package body LR.Synchro.Basique_Priorite_Redacteurs is
   
   function Nom_Strategie return String is
   begin
      return "Automate, lecteurs concurrents, Priorite aux rédacteurs";
   end Nom_Strategie;
...
end LR.Synchro.Basique_Priorite_Redacteurs;
