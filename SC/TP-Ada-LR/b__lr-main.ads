...
package ada_main is
   ...
   u00398 : constant Version_32 := 16#30466047#;
   pragma Export (C, u00398, "lr__synchroB");
   u00399 : constant Version_32 := 16#6f87cbb4#;
   pragma Export (C, u00399, "lr__synchroS");
   u00400 : constant Version_32 := 16#ce23361e#;
   pragma Export (C, u00400, "lr__synchro__exclusion_fifoB");
   u00401 : constant Version_32 := 16#915fd29c#;
   pragma Export (C, u00401, "lr__synchro__exclusion_fifoS");
   ...
   --  lr%s
   --  lr.synchro%s
   --  lr.synchro.exclusion_fifo%s
   --  lr.synchro%b
   --  lr.synchro.exclusion_fifo%b
   --  pango%s
   --  pango.enums%s
   --  pango.enums%b
   --  pango.attributes%s
